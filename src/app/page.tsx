    ...
    <div className="min-h-screen bg-[#030303] text-white selection:bg-blue-500/30 selection:text-blue-200">
      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-[#030303]/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-5xl mx-auto px-6 h-20 flex items-center justify-between">
          <span className="font-bold tracking-[0.3em] text-xs">PRATIK PATIDAR</span>
          <div className="hidden md:flex gap-8 text-[10px] font-bold tracking-widest uppercase text-white/40">
